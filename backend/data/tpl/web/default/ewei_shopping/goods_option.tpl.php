...
<script language="javascript">
	...
	for(var i=0;i<newlen;i++){
		...
		ids =ids.join('_');
		titles= titles.join('+');
		var val ={ id : "", title:titles, stock : "", costprice : "", productprice : "", marketprice : "", weight : "", comm1 : "", comm2 : "", comm3 : ""};
		if( $(".option_id_" + ids).length>0){
			val ={
				...
				comm1 : $(".option_comm1_" + ids+":eq(0)").val(),
				comm2 : $(".option_comm2_" + ids+":eq(0)").val(),
				comm3 : $(".option_comm3_" + ids+":eq(0)").val()
			}
		}
		console.log(val)
		hh += '<td class="info">'
		...
		hh += '<td class="info"><input name="option_comm1_' + ids +'[]" type="text" class="form-control option_comm1 option_comm1_' + ids +'" " value="' +(val.comm1=='undefined'?'':val.comm1 )+'"/></td>';
		hh += '<td class="info"><input name="option_comm2_' + ids +'[]" type="text" class="form-control option_comm2 option_comm2_' + ids +'" " value="' +(val.comm2=='undefined'?'':val.comm2 )+'"/></td>';
		hh += '<td class="info"><input name="option_comm3_' + ids +'[]" type="text" class="form-control option_comm3 option_comm3_' + ids +'" " value="' +(val.comm3=='undefined'?'':val.comm3 )+'"/></td>';
		hh += "</tr>";
	}
