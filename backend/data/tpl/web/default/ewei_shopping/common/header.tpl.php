	...
	<div class="navbar navbar-inverse navbar-static-top" role="navigation" style="position:static;">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li<?php  if($row['name'] == $solution['name']) { ?> class="active"<?php  } ?>><a href="<?php  echo url('home/welcome/ext');?>"><i class="fa fa-cog"></i><?php  echo $row['title'];?></a></li>
				<?php  } } ?>
				<?php  if(IMS_FAMILY != 'x') { ?>
			...
			<?php  } else { ?>
			<ul class="nav navbar-nav">
				<?php  if(!empty($_W['isfounder']) || empty($_W['setting']['permurls']['sections']) || in_array('platform', $_W['setting']['permurls']['sections'])) { ?>
					<li<?php  if(FRAME == 'platform') { ?> class="active"<?php  } ?>>
						<a href="<?php  echo url('home/welcome/platform');?>"><i class="fa fa-cog"></i>基础设置</a>
					</li>
				<?php  } ?>

				<?php  if(!empty($_W['isfounder']) || empty($_W['setting']['permurls']['sections']) || in_array('mc', $_W['setting']['permurls']['sections'])) { ?>
					<li<?php  if(FRAME == 'mc') { ?> class="active"<?php  } ?>>
						<a href="<?php  echo url('home/welcome/mc');?>"><i class="fa fa-mortar-board"></i>粉丝营销</a>
					</li>
				<?php  } ?>

				<?php  if(!empty($_W['isfounder']) || empty($_W['setting']['permurls']['sections']) || in_array('mc', $_W['setting']['permurls']['sections'])) { ?>
					<li<?php  if(FRAME == 'ext' || FRAME == 'ma' || $_GPC['m'] == 'ewei_shopping') { ?> class="active"<?php  } ?>>
						<a href="<?php  echo url('home/welcome/ext', array('m' => 'ewei_shopping'));?>"><i class="fa fa-shopping-cart"></i>微商城</a>
					</li>
				<?php  } ?>
				
				<?php  if(!empty($_W['isfounder']) || empty($_W['setting']['permurls']['sections']) || in_array('setting', $_W['setting']['permurls']['sections'])) { ?>
					<li<?php  if(FRAME == 'setting') { ?> class="active"<?php  } ?>>
						<a href="<?php  echo url('home/welcome/setting');?>"><i class="fa fa-gift"></i>功能选项</a>
					</li>
				<?php  } ?>

				<?php  if(!empty($_W['isfounder']) || empty($_W['setting']['permurls']['sections']) || in_array('census', $_W['census']['permurls']['sections'])) { ?>
					<li<?php  if(FRAME == 'census') { ?> class="active"<?php  } ?>>
						<a href="<?php  echo url('census/count');?>"><i class="fa fa-umbrella"></i>统计</a>
					</li>
				<?php  } ?>

				<?php  if(!empty($_W['isfounder']) || empty($_W['setting']['permurls']['sections']) || in_array('ext', $_W['setting']['permurls']['sections'])) { ?>
					<?php  if($_W['usability']['hidden'] == 1 || $_W['usability']['developer'] == $_W['user']['uid']) { ?>
						<li<?php  if(FRAME == 'ext' && $_GPC['m'] != 'ewei_shopping') { ?> class="active"<?php  } ?>>
							<a href="<?php  echo url('home/welcome/ext');?>"><i class="fa fa-cubes"></i>扩展功能</a>
						</li>
					<?php  } ?>
				<?php  } ?>
				<?php  if(FRAME == 'solution') { ?>
					<li class="active">
						<a href="<?php  echo url('home/welcome/solution', array('m' => $m));?>"><i class="fa fa-comments"></i>
							行业功能 - <?php  echo $solution['title'];?>
						</a>
					</li>
				<?php  } ?>
				<?php  if(IMS_FAMILY != 'x') { ?>
