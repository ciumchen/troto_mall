	...
	<form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="form1">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">是否开启显示</label>
					<div class="col-sm-9 col-xs-12">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">社区显示</label>
					<div class="col-sm-9 col-xs-12">
						<label class='radio-inline'>
							<input type='radio' name='community' value='1' <?php  if($category['community']==1) { ?>checked<?php  } ?> /> 是
						</label>
						<label class='radio-inline'>
							<input type='radio' name='community' value='0' <?php  if($category['community']==0) { ?>checked<?php  } ?> /> 否
						</label>
					</div>
				</div>
			</div>
