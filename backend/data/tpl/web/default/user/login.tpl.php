...
<div class="login">
	...
	<div class="center-block footer" role="footer">
		<div class="text-center">
			<?php  if(empty($_W['setting']['copyright']['footerright'])) { ?><?php  echo $_W['config']['site']['name'];?>&nbsp;<?php  } else { ?><?php  echo $_W['setting']['copyright']['footerright'];?><?php  } ?><?php  if(!empty($_W['setting']['copyright']['statcode'])) { ?><?php  echo $_W['setting']['copyright']['statcode'];?><?php  } ?>
			<?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?></a><sup>&copy;</sup>&nbsp; All Rights Reserved <?php  echo date('Y')?><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?>
		</div>
		<!-- <div class="text-center">
			<?php  if(empty($_W['setting']['copyright']['footerright'])) { ?><a href="#">关于微擎</a>&nbsp;&nbsp;<a href="http://bbs.we7.cc">微擎帮助</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerright'];?><?php  } ?> &nbsp; &nbsp; <?php  if(!empty($_W['setting']['copyright']['statcode'])) { ?><?php  echo $_W['setting']['copyright']['statcode'];?><?php  } ?>
		</div>
		<div class="text-center">
			<?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <a href="#"><b>微擎</b></a> v<?php echo IMS_VERSION;?> &copy; 2014 <a href="#">www.we7.cc</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?>
		</div> -->
	</div>
</div>
<script>
