...
<div class="clearfix">
	...
	<form action="<?php  echo url('user/create')?>" method="post" class="form-horizontal" role="form" id="form1">
		...
		<div class="form-group">
			<label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label">用户权限</label>
			<div class="col-sm-10 col-lg-9 col-xs-12">
				<?php  foreach ($power as $key => $value):?>
					<label class="checkbox-inline">
					  <input type="checkbox" name="power[]" value="<?php  echo $key;?>"><?php  echo $value;?>
					</label>
				<?php  endforeach;?>
				<!-- <textarea id="" name="remark" style="height:80px;" class="form-control"><?php  echo $user['remark'];?></textarea> -->
				<span class="help-block">注：用于功能权限</span>
			</div>
		</div>
		<div class="form-group">
