					...
					<div class="panel-heading">
						<div class="row" style="font-size:16px; line-height:40px; color:#666;">
							...
							<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 text-right" style="position:static;">
								...
								<?php  } ?>
								<!-- 更新主页 -->
									<a href="<?php  echo $_W['siteroot'];?>app/index.php?i=<?php  echo $uni['uniacid'];?>&c=entry&do=savetohtml&m=ewei_shopping" class="manage" target="_balnk" data-toggle="tooltip" data-placement="bottom" title="更新主页" style="border-left:1px #DDD dashed; padding-left:10px; margin-left:10px;"><i class="fa fa-cog fa-refresh"></i></a>
							</div>
						</div>
					</div>
