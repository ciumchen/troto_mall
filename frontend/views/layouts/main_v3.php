...
<head>
    ...
    <link rel="dns-prefetch" href="http://cdn.10d15.com"/>
    ...
    <?php if(!in_array($this->context->id, ['home','goods'])){echo '<script type="text/javascript" src="/js/area.js?v=161210">_init_area();</script>';}?>
</head>
<?php $this->beginBody() ?>

<?= $content ?>

<?php include '../views/bottomNavBar.php'; ?>
