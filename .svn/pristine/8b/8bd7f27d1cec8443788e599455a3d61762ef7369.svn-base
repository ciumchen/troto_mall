    ...
    <section class="scrollView">
        <div class="order-list">
            ...
            <div class="order-process">
                ...
                <div class="order-process-bd"></div>
            </div>
        </div>
        <div class="palace clearfix">
            <a href="javascript:;" class="palace-grid">
                <div class="palace-grid-icon"><img src="/images/icon_order_i01.png"></div>
                <div class="palace-grid-text"><h2>完成下单</h2></div>
            </a>
            <a href="javascript:;" class="palace-grid mt10">
                <div class="palace-grid-icon"><img src="/images/icon_order_arrow.png"></div>
            </a>
            <a href="javascript:;" class="palace-grid">
                <div class="palace-grid-icon"><img src="/images/icon_order_i02.png"></div>
                <div class="palace-grid-text"><h2>等待服务</h2></div>
            </a>
            <a href="javascript:;" class="palace-grid mt10">
                <div class="palace-grid-icon"><img src="/images/icon_order_arrow.png"></div>
            </a>
            <a href="javascript:;" class="palace-grid">
                <div class="palace-grid-icon"><img src="/images/icon_order_i03.png"></div>
                <div class="palace-grid-text"><h2>结束订单</h2></div>
            </a>
        </div>
        <div class="divHeight"></div>
        <!-- <div class="order-shop"><div class="order-shop-hd"><i class="icon icon-shop"></i> 嘻哈杂货铺</div></div> -->
        <div class="order-product">
            <div class="order-product-hd">
                <img src="/uploads/lt/2BDZywIC.png">
            </div>
            <div class="order-product-bd">
                <h2>苹果新款笔记本电脑mac充电器MacBook Air/Pro电池电源适配器</h2>
                <p>数量:1 颜色:85W老款弯头18.5 4.6 A </p>
                <div class="order-text">
                    <span class="order-text-hd">￥199.90
                    </span>
                    <span class="order-text-bd">
                        <em>申请售后</em>
                        <em>加入购物车</em>
                    </span>
                </div>
        ...
        <div class="order-service">
            <div class="order-service-hd"><i class="icon icon-service"></i> 联系客服</div>
        </div>
        <div class="divHeight"></div>
        <div class="order-service">
            <div class="">发票类型：不开发票</div>
        </div>
        <div class="divHeight"></div>
        <div class="fk-list">
